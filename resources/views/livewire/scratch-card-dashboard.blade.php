        ...
        <div class="col-12 col-xl-12 stretch-card">
            <div class="row flex-grow-1">
                ...
                <div class="col-md-3 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body text-center">
                            <h6 class="card-title mb-2">Total Cards</h6>
                ...
                <div class="col-md-3 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body text-center">
                            <h6 class="card-title mb-2">Used Cards</h6>
                            <h3 class="mb-0">{{ $usedCards }}</h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body text-center">
                            <h6 class="card-title mb-2">Unused Cards</h6>
                            <h3 class="mb-0">{{ $unusedCards }}</h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body text-center">
                            <h6 class="card-title mb-2">Expired Cards</h6>
                            <h3 class="mb-0">{{ $expiredCards }}</h3>
                        </div>
                    </div>
                </div>
    ...
    <div class="col-lg-7 col-xl-8 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <!-- Header -->
                <h6 class="card-title mb-3">Month Wise Redemptions</h6>

                <!-- Description -->
                <p class="text-secondary">
                    This chart shows the number of scratch card redemptions (used cards) per month.
                </p>

                <!-- Chart -->
                <div id="monthlyWiseRedemptions" data-labels='@json($monthlyRedemptionsLabels)'
                    data-series='@json($monthlyRedemptions)' style="min-height:318px;width:100%;">
                </div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-baseline">
                    <h6 class="card-title mb-0">Scratch Card Stats</h6>

                </div>
                <div id="storageChart" data-used="{{ $usedCards }}" data-unused="{{ $unusedCards }}"
                    data-expired="{{ $expiredCards }}" style="min-height:260px;width:100%;"></div>
                <div class="row mb-3">
            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-baseline mb-3">
                  ...
                  <div class="btn-group" role="group">
                    <button type="button" class="btn btn-outline-primary @if($revenuePeriod==='day') active @endif" wire:click="setRevenueChartData('day')">Today</button>
                    <button type="button" class="btn btn-outline-primary d-none d-md-block @if($revenuePeriod==='week') active @endif" wire:click="setRevenueChartData('week')">Week</button>
                    <button type="button" class="btn btn-outline-primary @if($revenuePeriod==='month') active @endif" wire:click="setRevenueChartData('month')">Month</button>
                    <button type="button" class="btn btn-outline-primary @if($revenuePeriod==='year') active @endif" wire:click="setRevenueChartData('year')">Year</button>
                  </div>
                </div>

                <!-- Description -->
                <p class="text-secondary fs-13px mb-3">
                ...
                <!-- Revenue Chart -->
                <div id="revenueChart"
                  data-series='@json($revenueChartData)'
                  data-categories='@json($revenueChartCategories)'
  ...
  // Growth Chart - END
    ...
    // Revenue Chart
                ...
                if (revenueChartElement) {
                  const series = JSON.parse(revenueChartElement.dataset.series);
                  const categories = JSON.parse(revenueChartElement.dataset.categories);
...
//   // Monthly Sales Chart
//   const monthlyWiseRedemptionsElement = document.querySelector('#monthlyWiseRedemptions');
//   if (monthlyWiseRedemptionsElement) {
//     const monthlyWiseRedemptionsOptions = {
//       chart: {
//         type: 'bar',
//         height: '318',
//         parentHeightOffset: 0,
...
//     const monthlyWiseRedemptions = new ApexCharts(monthlyWiseRedemptionsElement, monthlyWiseRedemptionsOptions);
//     monthlyWiseRedemptions.render();
//   }
//   // Monthly Wise Redemptions Chart - END

// Monthly Wise Redemptions Chart
                  const monthlyWiseRedemptionsElement = document.querySelector('#monthlyWiseRedemptions');
                  if (monthlyWiseRedemptionsElement) {
                    const labels = JSON.parse(monthlyWiseRedemptionsElement.dataset.labels);
                    const series = JSON.parse(monthlyWiseRedemptionsElement.dataset.series);
                    const monthlyWiseRedemptionsOptions = {
                      chart: {
                        type: 'bar',
                        height: '318',
  ...
  if (storageChartElement) {
    const used = Number(storageChartElement.dataset.used);
    const unused = Number(storageChartElement.dataset.unused);
    const expired = Number(storageChartElement.dataset.expired);
  ...
  // Scratch Card Stats Donut Chart - END
